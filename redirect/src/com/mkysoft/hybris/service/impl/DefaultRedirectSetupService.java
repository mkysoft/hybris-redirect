 ...
 *
 */
public class DefaultRedirectSetupService implements RedirectSetupService
{
	...
	{
		return DefaultRedirectService.class.getResourceAsStream("/redirect/sap-hybris-platform.png");
	}
